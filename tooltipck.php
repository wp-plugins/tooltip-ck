...
//		add_action('wp_enqueue_scripts', array( $this, 'load_assets_files'));
	...
	function load_assets_files() {
		...
		wp_enqueue_style( 'tooltipck', plugins_url( 'tooltipck/assets/tooltipck.css' ) );
		wp_enqueue_script( 'tooltipck', plugins_url( 'tooltipck/assets/tooltipck.js' ) );
	}
